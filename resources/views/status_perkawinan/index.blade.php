...
@section('content')
    <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <br>
                            <table class="table table-hover" id="status_perkawinan-table" width="100%">
                                <thead>
                                    <tr>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('status_perkawinan.store') }}" method="POST">
                        @csrf
                        <div class="modal-header">
                            <h5 class="modal-title" id="createModalLabel">Tambah {{ ucReplaceUnderscoreToSpace('status_perkawinan') }}</h5>
        ...
        <script type="text/javascript">
            $(function () {
                $('#status_perkawinan-table').DataTable({
                    order: [
                        [0, 'desc']
                    ],
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('status_perkawinan.index') }}",
                    columns: [
                        { data: 'id', name: 'id' },
                        { data: 'nama', name: 'nama' },
            ...
            document.addEventListener("DOMContentLoaded", function() {
                document.addEventListener('click', function(event) {
                    if (event.target.classList.contains('delete-btn')) {
                        ...
                        const status_perkawinan_id = button.getAttribute('data-id');
                        const status_perkawinan_nama = button.getAttribute('data-nama');
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                form.setAttribute('action', `{{ url('status_perkawinan') }}/${status_perkawinan_id}`);
