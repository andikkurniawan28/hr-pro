...
@section('title')
    {{ ucReplaceUnderscoreToSpace('bank') }}
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <br>
                            <table class="table table-hover" id="bank-table" width="100%">
                                <thead>
                                    <tr>
                ...
                <div class="modal-content">
                    <form action="{{ route('bank.store') }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="createModalLabel">Tambah {{ ucReplaceUnderscoreToSpace('bank') }}</h5>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                document.addEventListener('click', function(event) {
                    if (event.target.classList.contains('delete-btn')) {
                        ...
                        const bank_id = button.getAttribute('data-id');
                        const bank_nama = button.getAttribute('data-nama');
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                form.setAttribute('action', `{{ url('bank') }}/${bank_id}`);
